...
const ContactBanner = () => {
  return (
    <div className="relative font-serif w-full h-[280px] flex items-center justify-center bg-gradient-to-r from-purple-600 via-pink-300 to-green-300 overflow-hidden">
      {/* Background Image */}
      <img
